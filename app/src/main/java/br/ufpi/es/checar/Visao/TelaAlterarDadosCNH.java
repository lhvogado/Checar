...
public class TelaAlterarDadosCNH extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button botao = (Button) findViewById(R.id.buttonConfirma);
        botao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(TelaAlterarDadosCNH.this, carregaDados.class);
                intent.putExtra("CPF", nome);
                startActivity(intent);
                finish();

                Toast.makeText(getApplicationContext(), "Dado buscado", Toast.LENGTH_LONG).show();
            }
        });
